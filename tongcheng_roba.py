...
activity = 'com.tongcheng.android.LoadingActivity'
...
device.touch(73, 458, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME * 2)

device.touch(41, 194, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(245, 268, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)


device.touch(157, 177, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(157, 307, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)
device.touch(188, 171, 'DOWN_AND_UP')
