...
activity = 'com.baidu.news.ui.IndexActivity'
...
device.touch(68, 161, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(127, 220, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(251, 307, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(131, 375, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(68, 317, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(89, 166, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

for i in range(0, 5):
    device.drag((160, 280), (160, 30))
    MonkeyRunner.sleep(WAITTIME)
    
device.touch(30, 404, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(131, 354, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
