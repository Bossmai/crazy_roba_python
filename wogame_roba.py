...
activity = 'com.unicom.android.game.activities.SplashActivity'
...
device.touch(203, 371, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)     

device.touch(239, 362, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(173, 170, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(232, 84, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

if random.randint(0, 8) % 8 == 0:
    device.touch(263, 187, 'DOWN_AND_UP')
