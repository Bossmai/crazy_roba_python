...
activity = 'fm.xiami.main.SplashActivity'
...
device.touch(156, 329, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(58, 285, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

for i in range(0, PLAYCOUNT):
    device.touch(279, 401, 'DOWN_AND_UP')
...
print "Monkey success."
    ...
    '''
device.touch(76, 460, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
