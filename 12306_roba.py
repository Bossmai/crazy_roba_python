...
package = 'com.KZ176201512078620'
activity = 'battymole.trainticket.a.SplashView'
...
device.touch(138, 98, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME)  

device.touch(199, 146, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME)   

device.touch(125, 170, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME) 
device.touch(184, 210, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME)      
device.touch(200, 220, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME)
device.touch(168, 385, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME)  
device.touch(160, 345, 'DOWN_AND_UP')  
MonkeyRunner.sleep(WAITTIME * 3)    
