...
activity = 'cn.emagsoftware.gamehall.GameHallShowcase'
...
device.touch(150, 332, 'DOWN')
MonkeyRunner.sleep(WAITTIME)

device.drag((280, 240), (40, 240))
MonkeyRunner.sleep(WAITTIME)

device.touch(86, 458, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
...
device.touch(86, 458, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
device.touch(171, 175, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
device.touch(140, 135, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
device.touch(109, 106, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
device.touch(86, 458, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
device.touch(86, 458, 'DOWN')
