...
activity = 'com.gome.ecmall.home.LaunchActivity'
...
for i in range(0, 4):
    device.drag((280, 240), (30, 240))
    MonkeyRunner.sleep(WAITTIME)
    
device.touch(159, 360, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(127, 173, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(262, 90, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(204, 228, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
...
device.touch(299, 57, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(130, 305, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
...
device.touch(87, 458, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
