...
activity = 'com.qq.reader.activity.SplashActivity'
...
if random.randint(0, 1) % 2 == 0 :
    device.touch(70, 233, 'DOWN')
else:
    device.touch(233, 233, 'DOWN')
MonkeyRunner.sleep(WAITTIME)

device.touch(159, 310, 'DOWN')
MonkeyRunner.sleep(WAITTIME)

device.touch(170, 402, 'DOWN')
MonkeyRunner.sleep(WAITTIME)

for i in range(0, 15):
    device.touch(262, 228, 'DOWN')
    MonkeyRunner.sleep(WAITTIME)

device.touch(77, 460, 'DOWN')
MonkeyRunner.sleep(WAITTIME)

device.touch(79, 410, 'DOWN')
MonkeyRunner.sleep(WAITTIME)
