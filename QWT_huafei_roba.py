...
package = 'com.sysk.szt'
activity = 'com.sysk.shenzhoutong.activity.WelcomeActivity'
...
device.touch(197, 214, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.type(str(random.randint(13000000000,13900000000)))
MonkeyRunner.sleep(WAITTIME)
