...
activity = 'com.youdao.note.activity2.SplashActivity'
...
device.touch(81, 463, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(159, 210, 'DOWN_AND_UP')
...
device.touch(267, 390, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.type('163 nice!')
