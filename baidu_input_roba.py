...
activity = 'com.baidu.input.ImeAppMainActivity'
...
device.touch(236, 200, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(28, 200, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(222, 350, 'DOWN_AND_UP')
...
device.touch(245, 335, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(273, 284, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

for i in range(0, 3):
    device.drag((160,300),(160,80))
    MonkeyRunner.sleep(WAITTIME)         

device.touch(190, 354, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(59, 171, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(200, 384, 'DOWN_AND_UP')
