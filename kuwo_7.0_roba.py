...
device.touch(31, 157, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(80, 352, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(40, 296, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

device.touch(78, 103, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)
...
while time.time() < end_time:
    device.touch(247, 411, 'DOWN_AND_UP')
