...
package = 'com.qihoo360.daily'
activity = 'com.qihoo360.daily.activity.SplashActivity'
...
device.touch(156, 375, 'DOWN_AND_UP')
MonkeyRunner.sleep(WAITTIME)

for i in range(0, 5):
    device.drag((160, 300), (160, 120))
    MonkeyRunner.sleep(WAITTIME)

MonkeyRunner.sleep(WAITTIME)

device.touch(80, 457, 'DOWN_AND_UP')
...
device.touch(262, 326, 'DOWN_AND_UP')
