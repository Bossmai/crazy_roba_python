...
package = 'com.getfun17.getfun'
activity = 'com.getfun17.getfun.login.LoadingActivity'
...
device.touch(109, 391, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(133, 245, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(296, 56, 'DOWN_AND_UP')

MonkeyRunner.sleep(WAITTIME)

device.touch(185, 367, 'DOWN_AND_UP')
